...
public class LyingSkeletonWithGoldPickaxeBlock extends HorizontalFacingBlock implements Waterloggable {
    ...
    private static final ItemStack pickaxe = Items.GOLDEN_PICKAXE.getDefaultStack();

    public LyingSkeletonWithGoldPickaxeBlock(Settings settings) {
        super(settings);
    ...
    public void onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        pickaxe.setDamage(ThreadLocalRandom.current().nextInt(ModConfigs.MIN_GOLD_PICKAXE_DAMAGE_DROP, ModConfigs.MAX_GOLD_PICKAXE_DAMAGE_DROP + 1));
