...
public class LyingSkeletonBlock2 extends HorizontalFacingBlock implements Waterloggable {

    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

    public LyingSkeletonBlock2(Settings settings) {
        super(settings);
    ...
    private static VoxelShape SHAPE = Block.createCuboidShape(4, 0, 4, 18, 3, 12);
